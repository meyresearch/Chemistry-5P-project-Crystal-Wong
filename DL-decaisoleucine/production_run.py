...
solvated_tmp = PDBFile('deca56D_solvated.pdb')
...
simulation.reporters.append(DCDReporter('deca56D_prd.dcd', 500, np.arange(0,193,1)))
simulation.reporters.append(CheckpointReporter('deca56D_prd.chk', reportInterval=1000))
simulation.reporters.append(StateDataReporter('deca56D_prd_file.txt', 500, step=True, potentialEnergy=True, temperature=True))
